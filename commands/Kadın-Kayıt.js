...
if(member.roles.cache.has(Kayıtvx.KadınRol)) return message.channel.send(buzzembed.setDescription(`${member}, Adlı Kullanıcı Zaten **Kadın** Olarak Kayıt Olmus`)).then(buzz => buzz.delete({timeout:5000}))
///////////////////////////////////////////////////////////////////////////////////
...
member.roles.set([Kayıtvx.KadınRol, Kayıtvx.KadınRol2, Kayıtvx.KadınRol3, Kayıtvx.BoosterİD]).catch()
}else{
member.roles.set([Kayıtvx.KadınRol, Kayıtvx.KadınRol2, Kayıtvx.KadınRol3]).catch()
}
if(member.user.username.includes(Kayıtvx.tag)) member.roles.add(Kayıtvx.EkipRolü).catch()
////////////////////////////////////////////////////////
message.react(Emoji.OnaylıEmoji)
////////////////////////////////////////////////////////
message.channel.send(buzzembed.setDescription(`${member}, AdlI Kullanıcıyı <@&${Kayıtvx.KadınRol}> Olarak Kayıt Etdim`).setFooter(`Toplam Kayıtınız: ${KayıtSayısı}`))
